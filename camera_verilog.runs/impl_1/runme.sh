...
HD_PWD='C:/Users/akif2/Desktop/depo/Lisans Dersleri/bitirme/bitirme_camera/camera_verilog1/camera_verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source camera_top_module.tcl -notrace
