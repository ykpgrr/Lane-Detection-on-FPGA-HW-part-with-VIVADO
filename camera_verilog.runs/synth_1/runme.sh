...
HD_PWD='C:/Users/akif2/Desktop/depo/Lisans Dersleri/bitirme/bitirme_camera/camera_verilog1/camera_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log camera_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source camera_top_module.tcl
